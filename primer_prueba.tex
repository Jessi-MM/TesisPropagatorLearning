...
\part{Detectecctores de rayos Gamma y Hadrones}\label{pt:manual}
...
interlingua se que. Al via multo esser specimen, campo responder que
da. Le usate medical addresses pro, europa origine sanctificate nos se.}
\part{Redes Neuronales}\label{pt:showcase}
...
interlingua se que. Al via multo esser specimen, campo responder que
da. Le usate medical addresses pro, europa origine sanctificate nos se.}
\part{Implementación de un modelo CNN para la distinción de Gammas y Hadrones con HAWC's Eye}\label{pt:showcase}
